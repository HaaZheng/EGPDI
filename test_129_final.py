...
parser.add_argument("--dataset_path", type=str, default='/home/lichangyong/Documents/zmx/Graph_fusion/Datasets/predicted_structure/Train_Test129/')
parser.add_argument("--edgefeats_path", type=str, default='/home/lichangyong/Documents/zmx/Graph_fusion/Datasets/predicted_structure/Train_Test129/edge_features/EdgeFeats_prediceted_SC_17_129.pkl')
...
def evaluate(model,data_loader):
    ...
    for label_batch, node_features_batch, graph_batch,efeat_batch,adj_batch,coors_batch in data_loader:
        ...
        with torch.no_grad():
            ...
            y_pred = model(graph_batch, node_features_batch,coors_batch,adj_batch,efeat_batch).to(device)  # ori
